                                ...
                                <div class="uk-accordion-content">
                                    <div class="price-list ">
                                        ...
                                        <form class="">
                                            ...
                                            <input id="range" class="item_filter max_price uk-range " type="range"
                                                   value="" min="100"
                                                   max="10000" step="1"
                                ...
                                <div class="uk-accordion-content brand__filter">
                                    <form>
                                        ...
                                        <label><input class="item_filter size uk-checkbox" value="xl" type="checkbox">
                                            XL</label>
                                        <label><input class="item_filter size uk-checkbox" value="x-x-l" type="checkbox">
                                            XXL</label>
                                        <label><input class="item_filter size uk-checkbox" value="x-x-x-l" type="checkbox">
                                            XXXL</label>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="Name__of__category mt-2">
                            <div class="heading d-flex">
                                <h3></h3><span class="text-muted">(showing 1-40 products)</span>
                            </div>
