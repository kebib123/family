                            ...
                            <div class="uk-accordion-content">
                                <div class="price-list ">
                                    ...
                                    <form class="" >
                                        ...
                                        <input id="range" class="item_filter prices uk-range " type="range" value="2" min="100" max="10000" step="1" oninput="document.getElementById('rangeValue').innerHTML = this.value">
                                    </form>
                                </div>
                            </div>
                        </li>
    ...
    <script>
        $(document).ready(function () {
            $('.item_filter').click(function (e) {
                max_pricess=$('.max_prices').val();
                brands = multilple_values('brands');
              price = multilple_values('prices');
                console.log(brands);
